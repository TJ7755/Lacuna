...
LAG_BUCKETS = (
    ...
    ("1-6h", 3_600, 21_600),
    ("6-24h", 21_600, 86_400),
    ("24-36h", 86_400, 129_600),
    ("36-48h", 129_600, 172_800),
    ("2-3d", 172_800, 259_200),
    ("3-4d", 259_200, 345_600),
    ("4-5d", 345_600, 432_000),
    ("5-6d", 432_000, 518_400),
    # Upper bound is exclusive, so 604_801 is used to include exactly 604_800s (7 days).
    ("6-7d", 518_400, 604_801),
)
