...
// instantly reversible. The four sections satisfy that and are switched many times in a
...
import { CardsIcon, ChartIcon, PathIcon, SettingsIcon } from '../ui/icons';
...
const SECTION_ICONS = [PathIcon, CardsIcon, ChartIcon, SettingsIcon];
