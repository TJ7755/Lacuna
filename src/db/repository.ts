...
/**
 * Sequence-generated cards (those with a `sequenceItemId`) may only be added,
 * edited, moved or removed via their sequence, which keeps them synced with
 * `sequenceGeneration`'s diffing. Guard the generic bulk card mutations against
 * being pointed at them by mistake.
 */
