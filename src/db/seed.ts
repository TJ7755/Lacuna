  ...
  try {
    ...
    const cards: Card[] = [
      ...
      exampleCard(
        ...
        'Choose a named checkpoint or final assessment from the course path or **Study**. Lacuna creates a persistent, time-budgeted plan over reached and studied cards in that assessment’s coverage, respecting exclusions. Cards are ranked by predicted assessment-day value; invalid model data uses ordinary Practice ordering.',
        ['scheduling', 'revision'],
        17,
      ),
      exampleCard(
      ...
      exampleCard(
        ...
        'Open **Search content** from the sidebar for the full library and Card filters, or press **Ctrl+K** for **Quick search**. Both search courses, lessons, notes and cards together; Search content can filter Cards by **due**, **new**, **leech**, **flagged**, and **suspended**.',
        ['search', 'navigation'],
        24,
      ),
      exampleCard(
