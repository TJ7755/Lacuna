...
- **A — Path:** the closest match to PR #296. A minimal goal heading leads into two essential figures and a quiet progress line. The path decoration, tick and supporting sentence were removed after feedback.
...
All three use Lacuna's existing font and colour tokens and action treatment. Completion badges and the redundant “Session complete” labels were removed after feedback. Timing, focus and the distraction explanation are available under Session details. The supplied screenshot is the data source: one card, 100% accuracy, 0% to 100% progress, 122.9s mean correct response and 97% focus.
