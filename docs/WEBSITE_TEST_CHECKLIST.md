...
- [ ] An archived-course card opens its existing path in read-only mode; study, practice and
      authoring controls remain absent until the separate Unarchive action restores the course.
