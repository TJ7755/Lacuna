# Lacuna — Specification (development head after v0.2.9 beta)
...
**Published release: v0.2.9 beta**, verified on 20 September 2026. The product is organised around
**courses, lessons, notes and cards** end to end, with no user-facing deck or folder surfaces. The earlier v0.1.0 Course
